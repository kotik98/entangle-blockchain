...
// AddGenesisDistributorCmd returns add-distributor cobra Command.
func AddGenesisDistributorCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "add-genesis-distributor [address_or_key_name] [end_date]",
