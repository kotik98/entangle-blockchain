...
import (
	...
	v5 "github.com/Entangle-Protocol/entangle-blockchain/x/evm/migrations/v5"
	v5types "github.com/Entangle-Protocol/entangle-blockchain/x/evm/migrations/v5/types"
...
func TestMigrate(t *testing.T) {
	...
	kvStore.Set(types.ParamStoreKeyEVMDenom, []byte("aNGL"))
	...
	require.Equal(t, "aNGL", params.EvmDenom)
